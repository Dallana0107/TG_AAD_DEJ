...
imagen = cv2.imread('imagen_final.jpg')
...
imagen_rgb = cv2.imread('imagen_final.jpg')
...
# # Prueba de ecualización con variación del parámetro gamma en un rango [0.1 - 2] con un espacio de 0.1
...
# Leer las imágenes
imagen_original = cv2.imread('imagen6.jpg')
